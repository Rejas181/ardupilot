...
void ModeGS::update()
{
    ...
    plane.Log_Write_GS(float(V_d,gamma_d),float(airspeed_vec_bf.x),float(airspeed_vec_bf.z),float(theta,vel_ang.y),float(Control.rtY.de),float(Control.rtY.dT)); //Escritura del registro
